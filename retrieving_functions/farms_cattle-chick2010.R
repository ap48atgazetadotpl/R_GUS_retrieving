...
for (k in 1:91) {urls <- paste0("https://bdl.stat.gov.pl/api/v1/data/by-variable/274123?format=json&page-size=30&unit-parent-id=0", codes[[k]], "&unit-level=6")
...
write_rds(df_total_result2, "Data/farms_cattle_chick_2010.rds")
