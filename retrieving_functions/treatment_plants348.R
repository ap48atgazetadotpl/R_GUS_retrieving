...
#P2398 - Ludność korzystająca z oczyszczalni ścieków w % ogólnej liczby ludności 60309
#P1692 - Oczyszczalnie komunalne 346 mechaniczne ; 347 mechaniczno-chemiczne; 348 biologiczne; 349 podwyższonym usuwaniem biogenów
#79133 - wodociąg 
#199206 - ludnosc 
...
for (k in 1:91) {urls <- paste0("https://bdl.stat.gov.pl/api/v1/data/by-variable/348?format=json&page-size=30&unit-parent-id=0", codes[[k]], "&unit-level=6")
...
write_rds(df_total_result2, "Data/treatment_plants348.rds")
