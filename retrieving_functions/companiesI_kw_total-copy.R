...
#Chec the gmina names, that have been not retrieved
retrieved <- as.data.frame(companies_Ikw_0_9$name
colnames()
missing <- anti_join(as.data.frame(companies_Ikw_0_9$name), as.data.frame(companies_Ikw_total$name), by = 'name') 
