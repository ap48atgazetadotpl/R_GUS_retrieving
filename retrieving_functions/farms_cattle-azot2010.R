...
#288584 - potas 
#288590 - wapn 
#w d.tonach czystego skladnika
#288568 - mineral zużycie w dt czystego składnika
#288580  - fosfor
#288574  - azot
#288586  - potas 
#288592  - wapn 
...
for (k in 1:91) {urls <- paste0("https://bdl.stat.gov.pl/api/v1/data/by-variable/288574?format=json&page-size=30&unit-parent-id=0", codes[[k]], "&unit-level=6")
...
write_rds(df_total_result2, "Data/farms_cattle_azot_2010.rds")
